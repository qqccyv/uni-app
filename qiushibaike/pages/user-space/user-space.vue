<template>
	<view>
		...
		<!-- tab导航 -->
		<swiper-tab-head :tabBars="tabBars" :tabIndex="tabIndex" @tabtap="tabtap" itemStyle="width: 33%">
		</swiper-tab-head>
...
<script>
	...
	export default {
		...
		methods: {
			...
			guanzhu(index) {
				this.tablist[this.tabIndex].list[index].isguanzhu = !this.tablist[this.tabIndex].list[index].isguanzhu
			},
			// 上拉加载更多
			loadmore() {
